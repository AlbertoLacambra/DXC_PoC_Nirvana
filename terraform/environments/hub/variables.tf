...
# NOTE: Common variables (subscription_id, tenant_id, environment, location, tags)
# are auto-generated by Terragrunt. See: terraform/terragrunt.hcl
# Only hub-specific variables should be defined here
