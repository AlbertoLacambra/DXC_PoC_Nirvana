...
source: https://github.com/github/awesome-copilot/blob/main/prompts/first-ask.prompt.md
category: workflow
tags: ["workflow", "refinement", "interactive", "planning"]
author: GitHub Copilot Community
version: 1.0.0
imported: 2025-11-05
requires: ["joyride_request_human_input tool"]
---
...
**Note**: This prompt requires the Joyride extension and access to the `joyride_request_human_input` tool for interactive refinement.

**Full Documentation**: See [original prompt](https://github.com/github/awesome-copilot/blob/main/prompts/first-ask.prompt.md) for complete implementation details.
